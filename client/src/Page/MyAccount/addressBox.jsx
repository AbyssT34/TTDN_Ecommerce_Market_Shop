...
const AddressBox = (props) => {
  ...
  return (
    <div>
      <div
        className="addressBox group relative w-full border border-dashed
                                     border-[rgba(0,0,0,0.2)] bg-[#fafafa] p-4 rounded-md cursor-pointer "
      >
        ...
        <span className="text-[13px] p-0 block w-100">
