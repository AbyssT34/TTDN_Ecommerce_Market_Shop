...
const AddSubCategory = () => {
  ...
  // FIX: dùng formFields2 thay vì formFields
  ...
  // FIX: set formFields2.parentId thay vì formFields.parentId
    ...
    <>
      <section className="p-5 bg-gray-50 grid grid-cols-2 gap-10">
        ...
        <form className="form py-3 p-8" onSubmit={handleSubmit2}>
          <h4 className="font-[600]">Add Third Category</h4>
          <div className="scroll max-h-[72vh] overflow-y-scroll pr-4 pt-4">
            <div className="grid grid-cols-2 mb-3 gap-5">
              <div className="col ">
                <h3 className="text-[14px] font-[500] mb-1 text-black">
                ...
                >
                  {/* FIX: thêm return trước <MenuItem> trong map lồng nhau */}
                  {context?.catData?.length !== 0 &&
                    context?.catData?.map((item, index) => {
                      return (
